# pod2man --section=1 --release="Debian" --center=" " --date="21 Sep 2011"
#
=head1 NAME
...
An example session with fakechroot:
 ...
 :/bin:/usr/bin/X11
 $ export FAKECHROOT_CMD_SUBST=/sbin/insserv=/bin/true:/usr/bin/ischro
 ot=/bin/true:/usr/bin/mkfifo=/bin/true
 $ fakeroot fakechroot debootstrap --variant=fakechroot sid /tmp/sid

 $ fakeroot fakechroot chroot /tmp/sid /bin/bash
 # cd /
...
Copyright (c) 2003, 2005, 2007, 2008, 2009, 2010, 2011 Piotr Roszatycki
<dexter@debian.org>

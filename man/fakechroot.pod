...
The environment type is guessed based on command name.  If I<command>
argument is fakeroot(1) this argument is ommited and next argument is
taken as environment type.
...
correctly.
 ...
 $ case "`FAKECHROOT_DETECT=1 /bin/true`" in fakechroot*) echo LOADED;; esac
